...
LANGS: dict[str, dict[str, str]] = {
    'de': {
        ...
        'app.module_leader_only': 'Dieser Bereich ist nur für die Teamleitung sichtbar.',
        ...
        'settings.data.admin_only': 'Import, Neu-Seed und Loeschen sind nur fuer Admins sichtbar.',
    ...
    'en': {
        ...
        'app.module_leader_only': 'This area is only visible to team leadership.',
        ...
        'settings.data.admin_only': 'Import, reseed and clear are only visible to admins.',
